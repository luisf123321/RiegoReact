                ...
                <div className="container" >
                    <div className="row  mt-3 mb-3  pt-3 pb-3 border rounded border-primary bg-light">
                        <div className="col-3 px-4 ml-3 mr-3 mt-3 mb-3 pt-3 pb-3 pr-3 pl-3 ">
                            ...
                            <div  className="px-2 " >                                                 
                                <button type="button" className="btn btn-success"> <grIcon.GrAddCircle/>Humedad Suelo</button>
                                <button type="button" className="btn btn-success"> <grIcon.GrAddCircle/>Capacidad De Campo</button>
                                <button type="button" className="btn btn-success"> <grIcon.GrAddCircle/>Cantidad de Agua Aplicada</button>                            
                            </div>
                            <div className="dropdown-divider " ></div> 
                        </div>
                        <div className="col-4 ">                             
